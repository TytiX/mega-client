...
exports.File = exports.LABEL_NAMES = void 0;
const tslib_1 = require("tslib");
/* eslint-disable */
const crypto_1 = require("./crypto");
const combined_stream_1 = tslib_1.__importDefault(require("combined-stream"));
const api_1 = require("./api");
const events_1 = require("events");
const url_1 = require("url");
const util_1 = require("./util");
const stream_1 = require("stream");
const stream_skip_1 = tslib_1.__importDefault(require("stream-skip"));
let notLoggedApi;
exports.LABEL_NAMES = ['', 'red', 'orange', 'yellow', 'green', 'blue', 'purple', 'grey'];
class File extends events_1.EventEmitter {
    ...
    loadMetadata(aes, opt) {
        ...
        this.key = crypto_1.formatKey(parts[parts.length - 1]);
    ...
    decryptAttributes(at) {
        if (!this.key)
            return this;
        at = crypto_1.d64(at);
        crypto_1.getCipher(this.key).decryptCBC(at);
    ...
    parseAttributes(at) {
        this.attributes = at;
        this.name = at.n;
        this.label = exports.LABEL_NAMES[at.lbl || 0];
    ...
    loadAttributes(cb) {
        ...
        this.api.request(req, (err, response) => {
            ...
            if (this.directory) {
                ...
                const aes = this.key ? new crypto_1.AES(this.key) : null;
    ...
    download(options, cb) {
        ...
        const stream = apiStart === start
            ? decryptStream
            : decryptStream.pipe(new stream_skip_1.default({
                skip: start - apiStart
            }));
        ...
        cs.request(req, (err, response) => {
            ...
            if (maxConnections === 1) {
                ...
                const combined = combined_stream_1.default.create();
    ...
    static fromURL(opt) {
        ...
        if (url.path && url.path.match(/\/(file|folder)\//) !== null) {
            ...
            return new File({
                ...
                key: fileKey,
                directory: url.path ? url.path.indexOf('/folder/') >= 0 : false,
                loadedFile: split[1]
            });
        }
        else {
