...
export function prepareKey (password: any) {
  let i, j, r
...
export function prepareKeyV2 (password: any, info: any, cb: any) {
...
class CTR {
  ...
  macs: any;
  mac: any;
  constructor (aes: any, nonce: any, start = 0) {
    this.key = aes.key
  ...
  incrementCTRBuffer (buf: any, cnt: any) {
