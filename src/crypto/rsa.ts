...
function ip (w: any, n: any, x: any, y: any, c: any) {
  let xl = x & bdm
  let xh = x >> bd
...
function toppart (x: any, start: any, len: any) {
  let n = 0
...
function simplemod (i: any, m: any) {
  let c = 0
  let v
...
function bmod2 (x: any, m: any, mu: any): any {
...
function bmodexp (g: any, e: any, m: any) {
  let a = g.concat()
  let l = e.length - 1
  let n = m.length * 2
  let mu = zeros(n + 1)
...
function RSAdecrypt (m: any, d: any, p: any, q: any, u: any) {
 ...
 */
function cryptoDecodePrivKey (privk: any) {
  const pubkey: any = []
 ...
 */
function cryptoRsaDecrypt (ciphertext: any, privkey: any) {
